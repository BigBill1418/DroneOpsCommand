...
_AC1 = uuid.UUID("a1000000-demo-0000-0000-000000000001")  # M30T
_AC2 = uuid.UUID("a1000000-demo-0000-0000-000000000002")  # M4TD
_AC3 = uuid.UUID("a1000000-demo-0000-0000-000000000003")  # Mavic 3E

_P1 = "p1000000-demo-0000-0000-000000000001"  # Mike Barnard
_P2 = "p1000000-demo-0000-0000-000000000002"  # Sarah Chen

_CU1 = uuid.UUID("c1000000-demo-0000-0000-000000000001")  # Demo Solar Co.
_CU2 = uuid.UUID("c1000000-demo-0000-0000-000000000002")  # Acme Construction
_CU3 = uuid.UUID("c1000000-demo-0000-0000-000000000003")  # City of Springfield
_CU4 = uuid.UUID("c1000000-demo-0000-0000-000000000004")  # Barnard Aerial Services

_M1 = uuid.UUID("m1000000-demo-0000-0000-000000000001")
_M2 = uuid.UUID("m1000000-demo-0000-0000-000000000002")
_M3 = uuid.UUID("m1000000-demo-0000-0000-000000000003")
_M4 = uuid.UUID("m1000000-demo-0000-0000-000000000004")
_M5 = uuid.UUID("m1000000-demo-0000-0000-000000000005")
_M6 = uuid.UUID("m1000000-demo-0000-0000-000000000006")

_F1  = uuid.UUID("f1000000-demo-0000-0000-000000000001")
_F2  = uuid.UUID("f1000000-demo-0000-0000-000000000002")
_F3  = uuid.UUID("f1000000-demo-0000-0000-000000000003")
_F4  = uuid.UUID("f1000000-demo-0000-0000-000000000004")
_F5  = uuid.UUID("f1000000-demo-0000-0000-000000000005")
_F6  = uuid.UUID("f1000000-demo-0000-0000-000000000006")
_F7  = uuid.UUID("f1000000-demo-0000-0000-000000000007")
_F8  = uuid.UUID("f1000000-demo-0000-0000-000000000008")
_F9  = uuid.UUID("f1000000-demo-0000-0000-000000000009")
_F10 = uuid.UUID("f1000000-demo-0000-0000-000000000010")
_F11 = uuid.UUID("f1000000-demo-0000-0000-000000000011")
_F12 = uuid.UUID("f1000000-demo-0000-0000-000000000012")
